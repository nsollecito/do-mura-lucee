<?xml version="1.0" encoding="UTF-8"?><cfLuceeConfiguration hspw="${WEB-HSPW}" salt="${WEB-HSPW-SALT}" version="4.5"><cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	-->
	<regional locale="en_US" timeserver="pool.ntp.org" timezone="America/New_York" use-timeserver="true"/>
